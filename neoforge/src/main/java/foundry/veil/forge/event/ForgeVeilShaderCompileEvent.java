...
public class ForgeVeilShaderCompileEvent extends Event implements IModBusEvent {
    ...
    private final Map<Identifier, ShaderProgram> updatedPrograms;

    public ForgeVeilShaderCompileEvent(ShaderManager shaderManager, Map<Identifier, ShaderProgram> updatedPrograms) {
     ...
     */
    public Map<Identifier, ShaderProgram> getUpdatedPrograms() {
