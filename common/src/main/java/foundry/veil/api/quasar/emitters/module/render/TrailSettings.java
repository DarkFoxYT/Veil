...
public class TrailSettings {
    ...
    public static final Codec<TrailSettings> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Identifier.CODEC.fieldOf("trailTexture").forGetter(settings -> settings.trailTexture),
    ...
    private Identifier trailTexture;
    private Trail.TilingMode tilingMode;
    private boolean billboard;
    private boolean parentRotation;
    private float trailWidthModifierFloat = 1f;

    public TrailSettings(int trailFrequency, int trailLength, Vector4fc trailColor, TrailWidthModifier trailWidthModifier, Identifier trailTexture, TrailPointModifier trailPointModifier, Trail.TilingMode tilingMode, boolean billboard, boolean parentRotation) {
    ...
    private TrailSettings(int trailFrequency, int trailLength, Vector4fc trailColor, float trailWidthModifier, Identifier trailTexture, float trailPointModifier, Trail.TilingMode tilingMode, boolean billboard, boolean parentRotation) {
        this.trailFrequency = trailFrequency;
        this.trailLength = trailLength;
        this.trailColor = new Vector4f(trailColor);
    ...
    public void setTrailTexture(Identifier trailTexture) {
        this.trailTexture = trailTexture;
    }
    ...
    public void renderImGuiSettings() {
        ...
        if (ImGui.inputText("Trail Texture" + this.hashCode(), trailTextureString)) {
            this.trailTexture = Identifier.parse(trailTextureString.get());
        }
